...
export function FloatingWhatsApp() {
  const whatsappUrl = "https://wa.me/554599112656?text=Olá! Gostaria de saber mais sobre a revisão de contratos bancários.";
      ...
      onClick={() => {
        if (typeof window !== 'undefined') {
          ...
          if ((window as any).gtag) (window as any).gtag('event', 'conversion', {
            send_to: 'AW-16853299784/1ypFCLf16akcEMjko-Q-',
